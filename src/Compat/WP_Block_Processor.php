<?php
/**
 * Polyfill for WP_Block_Processor class.
 *
 * This class is a polyfill for the WP_Block_Processor class introduced in WordPress 6.9.0.
 * It will only be loaded if the class doesn't already exist in WordPress Core.
 *
 * Source: WordPress 6.9.0 wp-includes/class-wp-block-processor.php
 *
