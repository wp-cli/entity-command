<?php
/**
 * Polyfill for WP_HTML_Span class.
 *
 * This class is a polyfill for the WP_HTML_Span class introduced in WordPress 6.2.0.
 * It will only be loaded if the class doesn't already exist in WordPress Core.
 *
 * Source: WordPress 6.9.0 wp-includes/html-api/class-wp-html-span.php
 *
